...
Mesh::Mesh(int gridSize)
{
    ...
    vertexShader = new Shader(vertex, Shader::SHADER_TYPE_VERTEX);
    fragmentShader = new Shader(fragment, Shader::SHADER_TYPE_FRAGMENT);
	...
	heightMap = getTexture("taranaki.png");
	baseImage = getTexture("taranakiMap.png");
